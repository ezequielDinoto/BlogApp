package android.com.blog.ui.home.adapter

import android.com.blog.core.BaseViewHolder
import android.com.blog.data.model.Post
import android.com.blog.databinding.PostItemViewBinding
    ...
    private  inner class HomeScreenViewHolder (
        ...
        override fun bind(item: Post) {
           Glide.with(context).load(item.post_image).centerCrop().into(binding.postImage)
            ...
            binding.postTimestamp.text = "Hace  2 hora"
        }
